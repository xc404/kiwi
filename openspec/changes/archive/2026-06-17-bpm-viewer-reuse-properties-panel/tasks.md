...
- [x] 3.2 Manual test: open an instance, switch root vs activity selection, confirm variable filtering and UI match previous behavior; confirm no console errors from missing `modeling` on viewer.
