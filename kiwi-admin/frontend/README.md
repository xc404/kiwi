...
Angular 管理端：低代码后台、**BPMN 流程设计**、图表与表单。独立 npm 工程，通过 HTTP 调用 [backend](../backend/README.md)。平台介绍、演示地址与界面截图见仓库根 [README.md](../../README.md)（[English](../../README.en.md)）。
...
- [../../README.md](../../README.md) — 仓库总览、目录 Map、截图（[English](../../README.en.md)）  
