...
@Component({
  selector: 'bpm-process-instance-viewer',
  templateUrl: './bpm-process-instance-viewer.html',
  styleUrl: './bpm-process-instance-viewer.scss',
  imports: [
    PageHeaderComponent,
...
export class BpmProcessInstanceViewer implements AfterViewInit, OnDestroy {
