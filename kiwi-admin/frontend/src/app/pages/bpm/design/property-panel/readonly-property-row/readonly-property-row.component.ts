...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, NzFormModule, NzIconModule, NzInputModule, NzPopoverModule, NzTooltipModule],
  templateUrl: './readonly-property-row.component.html',
  styleUrls: ['./readonly-property-row.component.css', '../../../../../shared/formly/formly-field-wrapper.css']
})
