 ...
 */
export const PROPERTY_PROVIDER_CONTRIBUTOR = new InjectionToken<PropertyProvider>(
    "PropertyProviderContributor",
);
...
export class CompositePropertyProvider {
    ...
    private readonly contributors = inject(
        PROPERTY_PROVIDER_CONTRIBUTOR,
