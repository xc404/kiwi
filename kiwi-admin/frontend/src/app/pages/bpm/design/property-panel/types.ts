...
export declare interface PropertyDescription {
  type?: string;
  key: string;
  name?: string;
...
export interface PropertyTab {
  name?: string;
  groups: Array<{ name: string; properties: PropertyDescription[]; important?: boolean }>;
}
...
export function isTextType(property: PropertyDescription): boolean {
  ...
  return property.htmlType ? textTypes.includes(property.htmlType) : property.type === 'string';
}
