...
@Component({
  ...
  imports: [PageHeaderComponent, CrudPage, DictItemsComponent, NzCardModule, NzButtonModule, NzIconModule, NzSplitterModule],
  standalone: true
})
export class DictComponent implements OnInit {
  ...
  private openGroupByCodeFromRoute(groupCode: string): void {
    this.http
      .get<{ content?: Array<{ id?: string; groupCode?: string; groupName?: string }> }>(
        'system/dict/group',
        {
          page: 0,
          size: 20,
