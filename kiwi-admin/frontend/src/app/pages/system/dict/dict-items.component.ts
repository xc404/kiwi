import { Component, effect, input, viewChild, AfterViewInit } from '@angular/core';
...
@Component({
  ...
  template: ` <crud-page [pageConfig]="pageConfig"> </crud-page> `,
  styleUrls: ['./dict.component.less'],
  imports: [CrudPage]
})
export class DictItemsComponent implements AfterViewInit {
