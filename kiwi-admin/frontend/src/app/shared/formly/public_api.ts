...
import { DictSelectFieldType } from './types/dict-select-type';
...
export interface FormlyExpressionConfig {
  /** 统一 expression 类型默认方言，默认 spel */
  defaultDialect?: ExpressionDialect;
}

export function formlyConfig(expressionConfig: FormlyExpressionConfig = {}): ConfigOption {
