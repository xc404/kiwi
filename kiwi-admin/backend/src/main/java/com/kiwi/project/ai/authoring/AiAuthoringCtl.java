...
public class AiAuthoringCtl extends BaseCtl {

    private final AiAuthoringProcessService authoringProcessService;

    @Operation(operationId = "aiAuthoring_start", summary = "启动 AI 写工作流编排实例")
    @PostMapping("/start")
    public AiAuthoringProcessService.StartResult start(@RequestBody StartRequest request) {
    ...
    public AiAuthoringProcessService.StatusResult status(@PathVariable String processInstanceId) {
    ...
    public AiAuthoringProcessService.StatusResult statusByTarget(
    ...
    public AiAuthoringProcessService.StatusResult completeTask(
