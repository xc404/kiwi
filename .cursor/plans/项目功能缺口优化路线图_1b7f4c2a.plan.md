...
- `.cursor/plans/bpm_designer_agent_greenfield_13dbd3a0.plan.md`（现行）
- `openspec/changes/archive/2026-08-24-cursor-plans/superseded/ai_场景生图优化_73adc83b.plan.md`（已过期）
