...
import com.kiwi.cryoems.bpm.movie.result.ctf.CtfPathResolver;
import com.kiwi.cryoems.bpm.movie.result.ctf.CtfResultSection;
import com.kiwi.cryoems.bpm.movie.result.motion.MotionResultSection;
import com.kiwi.cryoems.bpm.movie.result.vfm.VfmResultSection;
...
/**
 * 编排 motion / ctf 业务填充 {@link MovieResult}；VFM 由 {@link com.kiwi.cryoems.bpm.movie.activity.CryoemsApplyVfmMovieResultActivity} 单独处理。
 */
@Service
