...
/**
 * 在异步 Job 失败时（{@link org.operaton.bpm.engine.impl.jobexecutor.FailedJobListener} 调用
 * {@link org.operaton.bpm.engine.impl.jobexecutor.FailedJobCommandFactory} 之前），决定
 ...
 * 包装 {@link org.operaton.bpm.engine.impl.jobexecutor.FailedJobCommandFactory} 实现（与引擎内部
