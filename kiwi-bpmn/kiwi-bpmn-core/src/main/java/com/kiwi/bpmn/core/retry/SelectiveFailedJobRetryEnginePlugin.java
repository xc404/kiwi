...
/**
 * 在 {@link org.operaton.bpm.engine.impl.jobexecutor.FailedJobListener} 调用的
 ...
 * <p>
 * {@link org.operaton.bpm.engine.impl.bpmn.parser.BpmnParseListener} 仅作用于解析期，无法按运行期异常类型分支；
