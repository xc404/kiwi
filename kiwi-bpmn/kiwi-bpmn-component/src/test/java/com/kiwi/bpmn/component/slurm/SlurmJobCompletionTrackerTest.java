...
class SlurmJobCompletionTrackerTest {
    ...
    private SlurmJobCompletionTracker tracker;
    ...
    void setUp() {
        ...
        tracker = new SlurmJobCompletionTracker(slurmProperties, slurmFlagFileHandler, slurmJobRepository);
        persisted.clear();
